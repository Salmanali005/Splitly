        ...
        <div className="fade-slide-in" style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{
              ...
              <input type="checkbox" required style={{ accentColor: '#6C63FF', marginTop: 2 }} />
              <span>
                I agree to the{' '}
                <Link to="#" style={{ color: '#6C63FF', textDecoration: 'none' }}>Terms of Service</Link>
                {' '}and{' '}
                <Link to="#" style={{ color: '#6C63FF', textDecoration: 'none' }}>Privacy Policy</Link>
              </span>
            </div>
      ...
      <div style={{
        ...
        <div className="fade-in-right" style={{
          ...
          <div className="float-slow" style={{
            ...
            <span style={{ fontSize: 12, color: '#a09cff' }}>No credit card required</span>
          </div>
          ...
          <h2 style={{
            ...
            Split expenses<br />
            <span style={{ color: '#6C63FF' }}>without the hassle.</span>
          </h2>
          ...
          <p style={{
            ...
            Join thousands of users who already use Splitly to manage their group expenses. Free for up to 10 members.
          </p>
          ...
          <div style={{
            ...
            {[
              { icon: '✈️', text: 'Create unlimited trips' },
              { icon: '👥', text: 'Invite members via email' },
              { icon: '📊', text: 'Export reports (PDF/Excel)' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                alignItems: 'center',
